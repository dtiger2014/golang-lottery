...
// Get http://localhost:8080/admin/result?gift_id=0&uid=1&page=1
...
// GetDelete http://localhost:8080/admin/result/delete?id=1
...
// GetCheat http://localhost:8080/admin/result/cheat?
...
// GetReset http://localhost:8080/admin/result/reset?id=1
